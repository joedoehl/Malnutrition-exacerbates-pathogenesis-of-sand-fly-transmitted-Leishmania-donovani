...
The pairwise comparison based on the estimated marginal means showed that sand flies just as well on well-nourished aimals as on malnourished animals excluding any unintended parasite inoculation bias due to nutritional state (Appendix table `r TabNum + 2` and `r TabNum + 3`).
