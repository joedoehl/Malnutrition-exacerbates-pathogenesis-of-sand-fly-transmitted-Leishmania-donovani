...
We analysed a total of *N*=`r TotN` well-nourished (WN) and malnourished (MN) BALB/c mice for the frequency of a >=20% weight loss post-intradermal *Leishmania donovani* infection either by "needle" injection or sand fly bite (SF) (*N*: `r paste(paste(SubDat[["Odds Ratios"]][["data"]][1:4, "Total"] %>% names(.), SubDat[["Odds Ratios"]][["data"]][1:4, "Total"], sep = "="), collapse = ", ")`) by contingency table analysis and logistic regression.
